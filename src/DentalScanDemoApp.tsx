...
export default function DentalScanDemoApp() {
    ...
    const ScreenNav = () => (
        <aside className="lg:col-span-3 rounded-[28px] bg-white/90 backdrop-blur border border-slate-200 shadow-sm p-5 h-fit sticky top-6">
                    ...
                    >
                        ...
                        <div
                            className={`mt-1 text-sm leading-6 ${
                                currentScreen === item.key ? "" : "text-slate-500"
                            }`}
                        >
                            {item.description}
                        </div>
            ...
            <div className="mt-6 rounded-2xl bg-slate-50 border border-slate-200 p-4">
                <div className="text-sm font-medium">Demo scope</div>
                <ul className="mt-3 space-y-2 text-sm text-slate-600">
                    <li>• landing c ценностью продукта</li>
    ...
    const LandingScreen = () => (
        <div className="space-y-8">
            <section
                className="rounded-[32px] border border-slate-200 bg-gradient-to-br from-slate-950 via-slate-900 to-sky-950 text-white overflow-hidden shadow-xl">
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 p-8 md:p-10">
                    <div className="space-y-6">
                        <div
                            className="inline-flex items-center rounded-full bg-white/15 border border-white/20 px-3 py-1 text-sm text-white backdrop-blur">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <button
                                ...
                                className="rounded-2xl bg-white text-slate-900 px-5 py-3 font-medium hover:opacity-90 transition"
                            >
                                Открыть product demo
                            </button>
                            <button
                                onClick={() => setCurrentScreen("viewer")}
                                className="rounded-2xl border text-slate-900 border-white/20 bg-white/10 px-5 py-3 font-medium hover:bg-white/15 transition"
                            >
                                Смотреть AI viewer
                            </button>
                        </div>
                    ...
                    <div
                        className="rounded-[28px] border border-white/10 bg-white/5 p-4 md:p-5 backdrop-blur self-stretch">
                        <div className="rounded-[24px] bg-slate-950 border border-white/10 p-4 h-full">
                            <div className="flex items-center justify-between gap-3 border-b border-white/10 pb-4">
                                <div>
                                    <div className="text-lg font-semibold">AI analysis preview</div>
                                    <div className="text-sm text-slate-400">Patient ID 23421 · CBCT · Demo mode</div>
                                </div>
                                <div
                            ...
                            <div
                                className="mt-5 aspect-[16/11] rounded-[22px] bg-slate-900 relative overflow-hidden border border-white/10">
                                <div
                                ...
                                <div
                                    className="absolute left-[16%] top-[26%] h-20 w-20 rounded-full border-2 border-amber-300"/>
                                <div
                                    className="absolute left-[52%] top-[44%] h-24 w-24 rounded-full border-2 border-red-300"/>
                                <div
                                    className="absolute left-[70%] top-[24%] h-16 w-16 rounded-full border-2 border-cyan-300"/>

                                <div
                                    className="absolute left-4 top-4 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs text-white backdrop-blur">
                                    AI overlay ON
                                </div>

                                <div className="absolute bottom-4 left-4 right-4 grid grid-cols-1 sm:grid-cols-3 gap-2">
                                    <div
                                        className="rounded-xl bg-white/10 border border-white/10 px-3 py-2 text-xs text-white">
                                        Slice 128 / 412
                                    </div>
                                    <div
                                        className="rounded-xl bg-white/10 border border-white/10 px-3 py-2 text-xs text-white">
                            ...
                            <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <div className="rounded-2xl bg-slate-900 border border-white/10 p-4">
                                    ...
                                    <div className="mt-1 font-medium break-all text-xs">Периапикальное воспаление</div>
                                </div>
                                <div className="rounded-2xl bg-slate-900 border border-white/10 p-4">
                                    <div className="text-sm text-slate-400">Finding 2</div>
                                    <div className="mt-1 font-medium break-all text-xs">Снижение плотности кости</div>
                                </div>
                                <div className="rounded-2xl bg-slate-900 border border-white/10 p-4">
                                    <div className="text-sm text-slate-400">Finding 3</div>
                                    <div className="mt-1 font-medium break-all text-xs">Ретинированный зуб</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {featureCards.map((item) => (
                    <div key={item.title} className="rounded-[28px] bg-white border border-slate-200 shadow-sm p-6">
                        <div
                            className="h-11 w-11 rounded-2xl bg-sky-50 border border-sky-100 flex items-center justify-center text-sky-700 font-semibold">
                            +
                        </div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="rounded-[28px] bg-white border border-slate-200 shadow-sm p-6">
                    <div
                        className="inline-flex rounded-full bg-rose-50 text-rose-700 border border-rose-100 px-3 py-1 text-xs font-medium">
                        Problem
                    </div>
                    <h2 className="mt-4 text-2xl font-semibold">Какие боли решает продукт</h2>
                ...
                <div className="rounded-[28px] bg-white border border-slate-200 shadow-sm p-6">
                    <div
                        className="inline-flex rounded-full bg-emerald-50 text-emerald-700 border border-emerald-100 px-3 py-1 text-xs font-medium">
                        Solution
                    </div>
                    <h2 className="mt-4 text-2xl font-semibold">Как работает решение</h2>
                    <ul className="mt-5 space-y-3 text-slate-600 leading-7">
                ...
                <div className="rounded-[28px] bg-white border border-slate-200 shadow-sm p-6">
                    <section className="grid grid-cols-1 xl:grid-cols-[1.1fr_0.9fr] gap-6">
                        <div className="rounded-[28px] bg-white border border-slate-200 shadow-sm p-6">
                            ...
                            <h2 className="mt-4 text-2xl font-semibold">Основной user flow</h2>
                            <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                                {landingSections.steps.map((item, index) => (
                                    <div key={item} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                        <div
                                            className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-slate-900 text-white text-sm font-medium">
                                            {index + 1}
                                        </div>
...
">{item}</div>
                        ...
                        <div className="rounded-[28px] bg-white border border-slate-200 shadow-sm p-6">
                            <div
                                className="inline-flex rounded-full bg-sky-50 text-sky-700 border border-sky-100 px-3 py-1 text-xs font-medium">
                                Metrics
                            </div>
                            <h2 className="mt-4 text-2xl font-semibold">Целевые показатели</h2>
                    ...
                    <h2 className="mt-4 text-2xl font-semibold">Что делает DentalScan</h2>
            ...
            <section>
                <div className="rounded-[28px] bg-white border border-slate-200 shadow-sm p-6">
                    ...
                    <h2 className="mt-4 text-2xl font-semibold">Ключевой принцип</h2>
                    ...
                    <div className="mt-5 rounded-2xl bg-slate-50 border border-slate-200 p-4">
                        <div className="text-sm font-medium">Что учитывает концепт</div>
                        <ul className="mt-3 space-y-2 text-sm text-slate-600">
    ...
    const DashboardScreen = () => (
        <div className="space-y-6">
            <div
                className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 rounded-[28px] bg-white/90 backdrop-blur border border-slate-200 shadow-sm p-5">
                <div>
                    <div className="inline-flex rounded-full bg-slate-100 px-3 py-1 text-xs text-slate-600">
                        Operations dashboard
                    </div>
                    <h2 className="mt-3 text-2xl font-semibold">Исследования и статусы анализа</h2>
                ...
                <button
                    ...
                    className="rounded-2xl bg-slate-900 px-4 py-2.5 font-medium hover:opacity-90 transition"
                >
            ...
            <div className="rounded-[28px] bg-white border border-slate-200 shadow-sm overflow-hidden">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 px-5 py-4 border-b border-slate-200 bg-slate-50/70">
                    <div>
                        <h3 className="text-lg font-semibold">Список исследований</h3>
                        <p className="text-sm text-slate-500 mt-1">Demo dashboard для product showcase.</p>
                    </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                        {studies.map((study) => (
                            <tr key={study.id} className="border-t border-slate-100 hover:bg-slate-50/60 transition">
    ...
    const UploadScreen = () => (
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <div className="xl:col-span-2 rounded-[28px] bg-white border border-slate-200 shadow-sm p-6">
                ...
                <h2 className="mt-3 text-2xl font-semibold">Upload study</h2>
                ...
                <div className="mt-6 rounded-[28px] border-2 border-dashed border-slate-300 bg-slate-50 p-8 text-center">
                    ...
                    {uploadedFile && (
                        <div className="mt-4 rounded-2xl bg-white border border-slate-200 px-4 py-3 inline-block text-sm shadow-sm">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-1 gap-6">
            ...
            <div className="lg:col-span-9 space-y-6">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                    ...
                    <div className="rounded-[28px] bg-white border border-slate-200 shadow-sm p-5">
                        <h2 className="text-lg font-semibold">Report draft</h2>
    ...
    return (
        <div
            className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(14,165,233,0.08),transparent_28%),linear-gradient(to_bottom,#f8fbff,#f8fafc)] text-slate-900 p-4 md:p-8">
            <div className="max-w-7xl mx-auto space-y-8">
                <header
                    className="rounded-[32px] bg-white/80 backdrop-blur border border-slate-200 shadow-sm px-6 py-5 md:px-8 md:py-6">
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            <div
                                className="inline-flex items-center rounded-full bg-white px-3 py-1 text-sm text-slate-700 shadow-sm border border-slate-200">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <button
                                ...
                                className="rounded-2xl border border-slate-200 bg-white px-4 py-2.5 font-medium hover:bg-slate-50 transition"
                            >
                                Landing
                            </button>
                            <button
            ...
            <section
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div>
                        <div
                            className="inline-flex rounded-full bg-white/10 border border-white/10 px-3 py-1 text-xs text-slate-200">
                            CTA
                        </div>
                        <h2 className="mt-4 text-3xl font-semibold">Explore the product demo</h2>
                        <p className="mt-3 max-w-2xl text-slate-300 leading-7">
                            Перейди в demo-flow, чтобы посмотреть dashboard, upload flow, viewer с AI-находками и
                            черновик отчёта.
                        </p>
                    </div>
                    <div className="flex flex-wrap gap-3">
                        ...
                        <button
                            onClick={() => setCurrentScreen("viewer")}
                            className="rounded-2xl border text-slate-900 border-white/15 bg-white/10 px-5 py-3 font-medium hover:bg-white/15 transition"
                        >
                            Go to viewer
                        </button>
                    </div>
