    ...
    const UploadScreen = () => (
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-5">
                <h3 className="text-lg font-semibold">Что показать в demo</h3>
                <ul className="mt-4 space-y-3 text-sm text-slate-600">
                    <li>• Один тестовый файл / mock-кейс</li>
                    <li>• Плашку “AI analysis in progress”</li>
                    <li>• После клика — переход на Viewer</li>
                    <li>• Готовые findings справа</li>
                    <li>• Возможность скачать отчёт</li>
                </ul>

                <div className="mt-6 rounded-2xl bg-slate-50 border border-slate-200 p-4">
                    <div className="text-sm font-medium">Подсказка для быстрого MVP</div>
                    <p className="mt-2 text-sm text-slate-600">
                        Для портфолио можно не подключать реальный DICOM-viewer. Достаточно mock-экрана,
                        чтобы показать структуру продукта и user flow.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    <div
                        ...
                        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200">
                            <div>
                                <div className="text-lg font-semibold">Просмотр исследования</div>
        ...
        <div className="min-h-screen bg-slate-50 text-slate-900 p-6 md:p-10">
            <div className="max-w-full mx-auto space-y-8">
                <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <div className="inline-flex items-center rounded-full bg-white px-3 py-1 text-sm shadow-sm border border-slate-200">
                        ...
                        <p className="mt-3 max-w-full text-slate-600 text-base md:text-lg">
                            ...
                            автоматическое выявление подозрительных зон, быстрая проверка находок и формирование клинического отчёта.
                        </p>
                    </div>
                </header>
